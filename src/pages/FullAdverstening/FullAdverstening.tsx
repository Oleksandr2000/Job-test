...
import { FullAdversteningProps } from "./FullAdverstening.props";
						...
						<div className={styles.main}>
							...
							<div className={styles.aplly} id={styles.apllyTop}>
								...
								<div className={styles.rating}>
									<Paragraph size="add">Ratings left: {advertisement?.rating.count}</Paragraph>
							...
							<Paragraph size="small">Posted {advertisement?.createdAt[0].substring(0, 10)}</Paragraph>
							<br />
